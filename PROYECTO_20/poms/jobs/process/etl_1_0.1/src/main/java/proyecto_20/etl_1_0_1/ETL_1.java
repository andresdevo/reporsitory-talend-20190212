 ...
 * @status
 */
public class ETL_1 implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "ETL_1.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ETL_1.class);
	...
	private final String jobName = "ETL_1";
	private final String projectName = "PROYECTO_20";
	...
	JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_Cx5rEBUZEeq_HYVjTLZRXA", "0.1");
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(ETL_1.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_PROYECTO_20_ETL_1 = new byte[0];
		static byte[] commonByteArray_PROYECTO_20_ETL_1 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_PROYECTO_20_ETL_1.length) {
					if (length < 1024 && commonByteArray_PROYECTO_20_ETL_1.length == 0) {
						commonByteArray_PROYECTO_20_ETL_1 = new byte[1024];
					} else {
						commonByteArray_PROYECTO_20_ETL_1 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_PROYECTO_20_ETL_1, 0, length);
				strReturn = new String(commonByteArray_PROYECTO_20_ETL_1, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_PROYECTO_20_ETL_1) {
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final ETL_1 ETL_1Class = new ETL_1();

		int exitCode = ETL_1Class.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'ETL_1' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'ETL_1' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = ETL_1.class.getClassLoader()
					.getResourceAsStream("proyecto_20/etl_1_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = ETL_1.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ETL_1");
		}
		if (enableLogStash) {
...
/************************************************************************************************
 * 44047 characters generated by Talend Cloud Big Data on the 3 de diciembre de
 * 2019 9:28:55 CET
 ************************************************************************************************/